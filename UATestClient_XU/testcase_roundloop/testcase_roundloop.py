...
file1 = open('testcase_roundloop.txt', 'r')
for line in file1:
...
plt.title('Time measurement of a circular loop between sending and receiving a signal')
plt.legend()

plt.savefig("testcase_roundloop.png");
